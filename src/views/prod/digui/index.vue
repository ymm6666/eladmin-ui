    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        <!-- 搜索 -->
                ...
                <el-input v-model="query.diguiRemark1" clearable placeholder="预留1" style="width: 185px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
                <label class="el-form-item-label">预留2</label>
                <el-input v-model="query.diguiRemark2" clearable placeholder="预留2" style="width: 185px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
        <date-range-picker
      ...
      <el-dialog :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="500px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
          ...
          <el-form-item label="门板">
            <el-input v-model="form.diguiDoor" style="width: 370px;" />
          </el-form-item>
          ...
          <el-form-item label="预留1">
            <el-input v-model="form.diguiRemark1" style="width: 370px;" />
          </el-form-item>
          <el-form-item label="预留2">
            <el-input v-model="form.diguiRemark2" style="width: 370px;" />
          </el-form-item>
        </el-form>
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column prop="diguiRemark1" label="预留1" />
        <el-table-column prop="diguiRemark2" label="预留2" />
...
const defaultForm = { diguiId: null, diguiName: null, diguiWidth: null, diguiDeephight: null, diguiFunc: null, diguiDoor: null, diguiBaseprice: null, diguiFuncprice: null, serialFlag: null, diguiRemark1: null, diguiRemark2: null }
export default {
  name: 'ProdDigui',
  ...
  cruds() {
    return CRUD({ title: '地柜维护', url: 'api/prodDigui', idField: 'diguiId', sort: 'diguiId,desc', crudMethod: { ...crudProdDigui }})
  },
  data() {
    return {
      permission: {
      ...
      queryTypeOptions: [
        ...
        { key: 'diguiRemark1', display_name: '预留1' },
        { key: 'diguiRemark2', display_name: '预留2' }
      ]
    }
  },
  methods: {
